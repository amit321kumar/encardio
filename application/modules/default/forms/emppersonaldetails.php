...
class Default_Form_emppersonaldetails extends Zend_Form
{
	public function init()
	{
		...
		$doa = new ZendX_JQuery_Form_Element_DatePicker('doa');
		$doa->setOptions(array('class' => 'brdr_none'));	
		$doa->setAttrib('readonly', 'true');
		$doa->setAttrib('onfocus', 'this.blur()');
		...
		*/
		...
		$this->addElements(array($id,$userid,$genderid,$maritalstatusid,$nationalityid,$ethniccodeid,$racecodeid,$languageid,$dob,$doa,$bloodgroup,$submitadd));
