...
<?php     	
    ...
    public static function process_emp_excel($file_name)
    {
        ...
        {    		
            $column_salary_currency = 18;$column_salary_type = 19;$column_salary = 20; $column_ta = 21; $column_da = 22; $column_hra =23; $column_gratuity = 24; $column_pf =25; $column_os = 26; $column_cca = 27; $column_pda = 28; $column_vpa = 29; $column_medical = 30; 
                $column_arrear = 31; $column_ot = 32; $column_incentive = 33; $column_bonus = 34; $column_esi = 35; $column_advance = 36;
                $column_loan = 37; $column_esiemp = 38; $column_itded = 39; $column_medded = 40;
            $arrReqHeaders = array(
                ...
                $column_salary_type =>'Pay Frequency',$column_salary => 'Salary', $column_ta => 'TA', $column_da => 'DA', $column_hra => 'HRA', $column_gratuity => 'Gratuity', $column_pf => 'PF', $column_os => 'OS', $column_cca => 'CCA', $column_pda => 'PDA', $column_vpa => 'VPA', $column_medical => 'Medical', $column_arrear => 'Arrear', $column_ot => 'OT', $column_incentive => 'Incentive', $column_bonus => 'Bonus', $column_esi => 'ESI', $column_advance => 'Advance', $column_loan => 'Loan', $column_esiemp => 'ESI Employer',$column_itded => 'IT Deductions', $column_medded => 'Medical Deductions'
            );
                ...
                if($tot_rec_cnt > 0)
                {
                    for($i=2; $i <= $sizeOfWorksheet; $i++ )
                    {
                        ...
                        if($rowData[$column_salary_currency] !='' || $rowData[$column_salary] != '' || $rowData[$column_salary_type] != '')
                        {
                            $salary_data = array(
                                'user_id' => $user_id,
                                'currencyid' => isset($currency_arr[strtolower($rowData[$column_salary_currency])])?
                                                $currency_arr[strtolower($rowData[$column_salary_currency])]:null,
                                'salarytype' => isset($salary_type_arr[strtolower($rowData[$column_salary_type])])?
                                                $salary_type_arr[strtolower($rowData[$column_salary_type])]:null,
