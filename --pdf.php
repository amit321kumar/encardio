...
if(mysql_num_rows($myself_query)>0)
{
   ...
   $total_sal = $m_row->salary + $m_row->ta + $m_row->da + $m_row->hra + $m_row->os + $m_row->cca + $m_row->vpa + $m_row->pda + $m_row->medical + $m_row->arrear +$m_row->bonus;
   $gross_ded=$m_row->pf + $m_row->esi + $m_row->esiemp + $m_row->itded + $m_row->advance + $m_row->loan + $m_row->medded;
   $netpay= $total_sal - $gross_ded;
...
<tr>
<th colspan='4' style='background-color:#f5f5f5;'>Salary Slip for the Month of September</th>
</tr>
<tr>
<td colspan='2'>Pay Period</td>
<td colspan='2'>Sep 01, 2017 to Sep 30, 2017</td>
</tr>
<tr>
...
<tr style='background-color:#f5f5f5;'>
<td colspan='6'>This is computer generated payslip asnd does not require signature or any company seal.</td>
</tr>
</table> 
</body>
</HTML>";
